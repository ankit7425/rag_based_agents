...
🔍 Retrieves relevant information from Wikipedia based on user queries.
🤖 Uses an LLM to generate natural-language answers from retrieved context.
📚 Implements a RAG pipeline for knowledge-grounded responses.
🧠 Uses semantic search/vector retrieval to identify relevant content.
⚡ Provides concise and context-aware answers.
🔗 Can be integrated with LangChain and other AI/LLM frameworks.

Technologies: Python, LangChain, RAG, LLM, Wikipedia API, Vector Database, Embeddings, Semantic Search.
